...
<body>
    ...
    <Profile user_desc={description} user_photo_ref={img} display_name={display_name} user_id={user_id} username={username} user_location={location} applied_to={applied} shortlisted={bk}/>
